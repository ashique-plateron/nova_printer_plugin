...
import 'package:nova_printer_plugin/src/printing_service/model/epson/epson_impact_printer/epson_impact_printer.dart';
...
abstract class Printer {
  ...
  List<Map<String, dynamic>> getCommands(List<PrintCommand> commandList) {
  ...
  List<Map<String, dynamic>> getCommands2(List<PrintCommand2> commandList) {
    List<Map<String, dynamic>> commands = [];
    for (var element in commandList) {
      switch (element.type) {
...
//! DONE
  Map<String, dynamic> getTextCommand(PrintCommand2 element) {
  ...
  //! DONE
  Map<String, dynamic> getDividerCommand(PrintCommand2 element) {
  ...
  //!DONE
  Map<String, dynamic> getFeedLineCommand(PrintCommand2 element) {
    return element.toJson();
  }

  //!DONE
  Map<String, dynamic> getCutCommand(PrintCommand2 element) {
    return element.toJson();
  }

  //!DONE
  Map<String, dynamic> addRawData(PrintCommand2 element) {
    return element.toJson();
  }

  //!DONE
  Map<String, dynamic> getAddTextSmoothCommand(PrintCommand2 element) {
    return element.toJson();
  }

  //!DONE
  Map<String, dynamic> getAddImageCommand(PrintCommand2 element) {
    return element.toJson();
  }

  //!DONE
  Map<String, dynamic> getRowWith2ColumnCommand(PrintCommand2 element) {
  ...
  //!DONE
  Map<String, dynamic> getPrintQrCommand(PrintCommand2 element) {
    return element.toJson();
  }
}
